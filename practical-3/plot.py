...
titles = [
    "When sorted on age alone (Merge Sort)",
    "When sorted on name alone (Merge Sort)",
    "When sorted on age followed by name (Merge Sort)",
]

fig_names = ["age_only_merge", "name_only_merge", "both_merge"]
