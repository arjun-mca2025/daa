...
int main()
{
    ...
    if (choice == 0)
    {
        ...
        Metadata metadata = randomizedQuickSortWithMetadata(dataset, compareByTemperature);
    ...
    if (choice != 0)
    {
        for (int n = 10; n <= 100; n += 10)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                // Sort the samples
                auto currentMetadata = randomizedQuickSortWithMetadata(sampleOfSizeN, compareByTemperature);
